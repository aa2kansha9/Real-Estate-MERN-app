    ...
    <div className='flex flex-col md:flex-row'>
      <div className='p-7  border-b-2 md:border-r-2 md:min-h-screen'>
        <form onSubmit={handleSubmit} className='flex flex-col gap-8'>
          ...
          <div className='flex gap-2 flex-wrap items-center'>
            <label className='font-semibold text-gray-300'>Amenities:</label>
            <div className='flex gap-2'>
              <input
                type='checkbox'
                id='parking'
          ...
          <button className='bg-gray-600 text-white p-3 rounded-lg uppercase hover:opacity-95'>
            Search
          </button>
        </form>
      </div>
      <div className='flex-1'>
        <h1 className='text-3xl font-semibold border-b p-3 text-gray-200 mt-5'>
          Listing results:
        </h1>
        <div className='p-7 flex flex-wrap gap-4'>
          ...
          {showMore && (
            <button
              ...
              className='text-gray-300 hover:underline p-7 text-center w-full'
            >
              Show more
            </button>
          )}
